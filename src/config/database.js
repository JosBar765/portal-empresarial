...
const taggedHandlers = {
  ...
  'vale:insert': (params) => {
    ...
    const row = {
      ...
      descripcion_original: null, pdf_url: null, modificado: 0, justificacion_modificacion: null,
